...
$(nomePrograma): main.o Coordenada.o Pacman.o ConsoleDraw.o Character.o Node.o
	g++ -o $(nomePrograma) main.o Coordenada.o Pacman.o ConsoleDraw.o Character.o Node.o $(parametrosCompilacao)
